/**
 * OpenWikiInBrowserAction.javaTransactionMenuAction.java
 * created: 15.11.2008
...
public class OpenWikiInBrowserAction implements Action {
     ...
     */
    public OpenWikiInBrowserAction() {
        this.putValue(Action.NAME, MainFrame.RESOURCE.getString("Actions.OpenWiki.Label"));
    }
    ...
    public void actionPerformed(final ActionEvent aE) {
        try {
            final URL fileABugURL = new URL("http://apps.sourceforge.net/mediawiki/travelingsales/");
