...
/**
 * Action to change the setting "plugin.useImpl.IPaintVisitor" to
 * the SmoothTilePainter.
 * @author <a href="mailto:oleg_chubaryov@mail.ru">Oleg Chubaryov</a>
 */
public class SetTilePainter extends AbstractAction {

    /**
     * generated.
     */
    private static final long serialVersionUID = 4646037297740389621L;

    /**
     * Create the action and set the name.
     */
    public SetTilePainter() {
        super(MainFrame.RESOURCE.getString("Actions.SetTilePainter.Label"));
        putValue(Action.SHORT_DESCRIPTION, MainFrame.RESOURCE.getString("Actions.SetTilePainter.Description"));
        /*
    ...
    public void actionPerformed(final ActionEvent e) {
        Settings.getInstance().put("plugin.useImpl.IPaintVisitor", "org.openstreetmap.travelingsalesman.painting.SmoothTilePainter");
    }
}
